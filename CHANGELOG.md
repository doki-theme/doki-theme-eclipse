...
# 0.6.0 [Hanekawa, Shima Rin, Nagatoro, Yumeko, & Yuno]
...
# 0.5.0 [Nino, Nakano Miku, Gray, Miia, & Tohru]
...
# 0.2.0 [Echidna, Yukino, Kurisu, Asuna, Umi, & Konata]
...
- Initial MVP, fully leveraging the [Darkest Dark](https://marketplace.eclipse.org/content/darkest-dark-theme-devstyle) plugin from the Eclipse Marketplace.
